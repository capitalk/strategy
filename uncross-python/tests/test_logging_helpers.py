...
def create_logger(name, console_handler = None, console_level = None, 
  ...
  print "Attempting to create logger <name=%s, console_handler=%s, console_level=%s, file_name=%s, file_level=%s>" % (name, console_handler, console_level, file_name, file_level)
